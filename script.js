...
const GREETING = "Hello. I'm the ATAST Assistant. How can I help you today?";
...
function addRow(text, who) {
    ...
    avatar.textContent = who === "user" ? "You" : "AT";
    ...
    author.textContent = who === "user" ? "You" : "ATAST Assistant";
